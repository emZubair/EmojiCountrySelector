...
public struct Country {
    ...
    init(isoCode:String) {
        name = Country.countryName(from: isoCode)
        flagEmoji = Country.emojiFlag(from: isoCode)
